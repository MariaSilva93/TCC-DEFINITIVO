...
<head>
    ...
    <title>BoaForma | Cadastro exercício - Exercício Posterior</title>
</head>
<body>
    <h1>Continuação cadastro - Exercício Posterior</h1>
    ...
    <?php while ($sql = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
        <label for="exercID">Escolha o exercício:</label>
            <select name="exercID" required>
                ...
                <option value="41">1ㅤ|ㅤLeg-Press</option>
                <option value="42">2ㅤ|ㅤCadeira Flexora</option>
                <option value="43">3ㅤ|ㅤStiff</option>
            </select>
        <hr>
