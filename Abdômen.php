...
<body>
    <h1>Continuação cadastro - Abdômen</h1>
    ...
    <?php while ($sql = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
        <label for="exercID">Escolha o exercício:</label>
            <select name="exercID" required>
                ...
                <option value="1">1ㅤ|ㅤAbdominal Supa</option>
                <option value="2">2ㅤ|ㅤAbdominal Infra</option>
                <option value="3">3ㅤ|ㅤAbdominal Oblíquo</option>
                <option value="4">4ㅤ|ㅤPrancha Ventral</option>
            </select>
        <hr>
