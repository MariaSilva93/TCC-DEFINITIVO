...
<head>
    ...
    <title>BoaForma | Cadastro exercício - Exercício Quadríceps</title>
</head>
<body>
    <h1>Continuação cadastro - Quadríceps</h1>
    ...
    <?php while ($sql = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
        <label for="exercID">Escolha o exercício:</label>
            <select name="exercID" required>
                ...
                <option value="44">1ㅤ|ㅤCadeira Extensora</option>
                <option value="45">2ㅤ|ㅤAvanço</option>
                <option value="46">3ㅤ|ㅤLeg-Press</option>
                <option value="47">4ㅤ|ㅤAgachamento</option>
            </select>
        <hr>
