...
<head>
    ...
    <title>BoaForma | Cadastro exercício - Exercício Trapézio</title>
</head>
<body>
    <h1>Continuação cadastro - Trapézio</h1>
    ...
    <?php while ($sql = $stmt->fetch(PDO::FETCH_ASSOC)) : ?>
        <label for="exercID">Escolha o exercício:</label>
            <select name="exercID" required>
                ...
                <option value="18">1ㅤ|ㅤEncolhimento com Halteres</option>
                <option value="19">2ㅤ|ㅤEncolhimento com Barra por Trás</option>
                <option value="20">3ㅤ|ㅤRemada Alta</option>
                <option value="21">4ㅤ|ㅤEncolhimento com Barra pela Frente</option>
            </select>
        <hr>
